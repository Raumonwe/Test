 ...
 *   https://datatables.net/download/#dt/dt-1.12.1/fc-4.1.0/fh-3.2.3/r-2.3.0/sc-2.0.6/sb-1.3.3/sp-2.0.1
 *
 * Included libraries:
 *   DataTables 1.12.1, FixedColumns 4.1.0, FixedHeader 3.2.3, Responsive 2.3.0, Scroller 2.0.6, SearchBuilder 1.3.3, SearchPanes 2.0.1
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var select = $('<select/>', {
			...
			'class':         classes.sLengthSelect+' js-example-basic-single'
		} );
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.12.1/fc-4.1.0/fh-3.2.3/r-2.3.0/sc-2.0.6/sb-1.3.3/sp-2.0.1",
